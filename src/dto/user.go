...
import service "RestGoTest/src/services/dto"
...
func (from RegisterUserByUsernameRequest) ToRegisterUserByUsername() service.RegisterUserByUsername {
	return service.RegisterUserByUsername{
